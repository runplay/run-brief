...
public class OAuth2Authenticator {
   ...
   */
  public static void go(String email, String oauthToken) throws Exception {

      //BLog.e("BAAAAAAD","Start - init");
    initialize();
     //BLog.e("BAAAAAAD","try IMAP");
    IMAPStore imapStore = connectToImap("imap.gmail.com",
                                        993,
                                        email,
                                        oauthToken,
                                        true);
    //BLog.e("BAAAAAAD","Successfully authenticated to IMAP.");
    SMTPTransport smtpTransport = connectToSmtp("smtp.gmail.com",
                                                587,
                                                email,
                                                oauthToken,
                                                true);
      //BLog.e("BAAAAAAD","Successfully authenticated to SMTP.");
  }
}
