...
public class PersonFull {
	...
	private String IM;
	private HashMap<String,HashMap<addressField,String>> address=new HashMap();
    ...
    */
    ...
    public void loadOtherData(Activity activity) {
        ...
        if(noteCur.getCount()>0) {
            ...
            while (noteCur.moveToNext()) {
                ...
                if(note!=null && note.length()>0)
                    notes.add(note);
                //BLog.e("LOADOTHER","note: "+noteCur.getString(noteCur.getColumnIndex(ContactsContract.CommonDataKinds.Note.NOTE)));
            }
            setNotes(notes);
        }
        noteCur.close();
        //BLog.e("CC", "helllllllllllllllloooooooooooooooooooooooo");
        //Get Postal Address....
        ...
        //BLog.e("CC","helllllllllllllllloooooooooooooooooooooooo222222222222222222222");
