...
import run.brief.util.TitleBarWebView;

public class NotesWebView extends TitleBarWebView {
    ...
    public NotesWebView(Context context) {
        super(context);
    }
    ...
    public NotesWebView(Context context, AttributeSet attrs, int defStyle) {
    ...
    public void blockNetworkData(final boolean shouldBlockNetworkData) {
        ...
        if (mGetBlockNetworkLoads != null) {
            try {
                ...
                BLog.add("NotesWebView - Error on invoking WebSettings.setBlockNetworkLoads()", e);
            }
        }
...
*/
        ...
        webSettings.setTextSize(B.getFontSizes().getMessageViewContent());
    ...
    public void emulateShiftHeld() {
        try {
            ...
            //BLog.add("NotesWebView - Exception in emulateShiftHeld()", e);
        }
    }
    */
