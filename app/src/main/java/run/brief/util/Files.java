...
public class Files {
	...
	public static final String HOME_PATH_FILES=SDCARD_PATH+"/Brief";
    ...
    public static void setAppHomePath(Context context) {
        ...
        //BLog.e("PATH",HOME_PATH_APP);
    }

	//public static final String FILENAME_PERMISSIONS="PEM.dat";
	//public static final String FILENAME_GENERAL_SETTINGS="SET.dat";
    public static final String FILENAME_PERMISSIONS="BPM.dat";
    public static final String FILENAME_GENERAL_SETTINGS="BSE.dat";
	
	public static final String FILENAME_USER_STATS="USS.dat";
	
	public static final String FILENAME_NOTES_DATABASE="NTD.dat";
	...
	//public static final String FILENAME_RSS_CATEGORY="RSC.dat";
	//public static final String FILENAME_RSS_FEEDS="RSF.dat";
	//public static final String FILENAME_RSS_FEEDS_USER_DEFINED="RSUD.dat";
	/*
	public static final String FILENAME_RSS_USER_STORE="RSUS.dat";
	*/
	public static final String FILENAME_ACCOUNTS="BRA.dat";

	public static final String FILENAME_ERRORS="ERR.dat";
	
	// get rid of this when reading from accountsDb is done
	//public static final String FILENAME_TWITTER_ACCOUNTS="TWA.dat";
	//public static final String FILENAME_LINKEDIN_ACCOUNTS="LIA.dat";
	//public static final String FILENAME_FACEBOOK_ACCOUNTS="FBA.dat";
	
	public static final String FILENAME_FILE_LOCKER="FLO.dat";
    public static final String FILENAME_FILE_SIGNATURES="SGN.dat";



	
	//public static final String FILENAME_EMAIL_ACCOUNTS="EMA.dat";
	//public static final String FILENAME_EMAIL_DATABASE="EMD.dat";
	//public static final String FILENAME_ERRORS="ERR.dat";
	public static final String FILENAME_TWITTER_DATABASE="TWD.dat";
	
	
	public static final String FILENAME_LINKEDIN_DATABASE="LID.dat";
	//public static final String FILENAME_LINKEDIN_ACCOUNTS="LIA.dat";
	public static final String FILENAME_FACEBOOK_DATABASE="FBD.dat";
	//public static final String FILENAME_FACEBOOK_ACCOUNTS="FBA.dat";
	
	public static final String FOLDER_RSS_IMAGES="_img_rss";
	public static final String FOLDER_TWITTER_IMAGES="_img_tw";
	public static final String FOLDER_FACEBOOK_IMAGES="_img_tw";
	public static final String FOLDER_LINKEDIN_IMAGES="_img_li";
	...
	public static final String FOLDER_EMAIL_ATTACHMENTS="_email";
	public static final String FOLDER_LOCKER="_oth";
    public static final String FOLDER_TMP="tmp";
	
	public static final String APPEND_THUMBNAIL="_s";
	...
	public static Drawable getFileIcon(Context context, String fileOrFilePath) {
		if(fileOrFilePath!=null) {
			...
			if(extp>1) {
				...
				if(Rval!=null) {
					Drawable d= B.getDrawable(context,Rval.intValue());
					if(d!=null)
						return d;
				}
			} else {
				return B.getDrawable(context,F_DIR);
			}
		}
		return B.getDrawable(context,F_NO);
	}
