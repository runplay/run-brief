	...
	public FileExploreAdapter(Activity a, FileManager filemanager,boolean isMultiSelect) {
	    ...
	    public View getView(final int position, View view, ViewGroup parent) {
	        ...
	        if (view == null) {
	            ...
	            view.setTag(holder);
				B.addStyle(holder.title,holder.data,holder.date);
	        }
			...
			if(item!=null) {
				...
				if (fm.getSelectedFiles().get(item.getAbsolutePath()) != null) {
					...
					holder.check.setImageDrawable(B.getDrawable(activity, R.drawable.s_checkon));
					...
					holder.check.setImageDrawable(B.getDrawable(activity, R.drawable.s_checkoff));
