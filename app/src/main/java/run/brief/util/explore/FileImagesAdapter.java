...
public class FileImagesAdapter extends BaseAdapter {
    ...
    RelativeLayout.LayoutParams iconrlp;
    ...
    public FileImagesAdapter(Activity c, GridView parent, FileManager fileManager) {
        ...
        iconrlp=new RelativeLayout.LayoutParams(100, 100);
        iconrlp.setMargins(0,160,0,0);
        ...
        if(f!=null) {
            ...
            if(Files.isImage(Files.removeBriefFileExtension(f.getName()))) {
                //if(!isFastScroll)
                    ...
                    imageView.setImageDrawable(B.getDrawable(activity,f.icon));

                    imageView.setLayoutParams(iconrlp);
                    imageView.setScaleType(ImageView.ScaleType.CENTER_CROP);
