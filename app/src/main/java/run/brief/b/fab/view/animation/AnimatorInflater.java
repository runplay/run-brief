...
public class AnimatorInflater {
    ...
    /**
     * Loads an {@link run.brief.b.fab.view.animation.Animator} object from a resource
     *
     ...
     */
    public static run.brief.b.fab.view.animation.Animator loadAnimator(Context context, int id)
    ...
    private static run.brief.b.fab.view.animation.Animator createAnimatorFromXml(Context c, XmlPullParser parser)
    ...
    private static run.brief.b.fab.view.animation.Animator createAnimatorFromXml(Context c, XmlPullParser parser,
                                                                                 AttributeSet attrs, run.brief.b.fab.view.animation.AnimatorSet parent, int sequenceOrdering)
            throws XmlPullParserException, IOException {

        run.brief.b.fab.view.animation.Animator anim = null;
        ArrayList<run.brief.b.fab.view.animation.Animator> childAnims = null;
        ...
        while (((type=parser.next()) != XmlPullParser.END_TAG || parser.getDepth() > depth)
            ...
            if (name.equals("objectAnimator")) {
                ...
                createAnimatorFromXml(c, parser, attrs, (run.brief.b.fab.view.animation.AnimatorSet) anim,  ordering);
                a.recycle();
            } else {
            ...
            if (parent != null) {
                if (childAnims == null) {
                    childAnims = new ArrayList<run.brief.b.fab.view.animation.Animator>();
                }
                childAnims.add(anim);
            }
        }
        if (parent != null && childAnims != null) {
            run.brief.b.fab.view.animation.Animator[] animsArray = new Animator[childAnims.size()];
            int index = 0;
            for (run.brief.b.fab.view.animation.Animator a : childAnims) {
                animsArray[index++] = a;
            }
