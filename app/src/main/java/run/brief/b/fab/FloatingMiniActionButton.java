...
public class FloatingMiniActionButton extends ImageButton {
    ...
    public FloatingMiniActionButton(Context context) {
        this(context, null);
    }

    public FloatingMiniActionButton(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context, attrs);
    }

    public FloatingMiniActionButton(Context context, AttributeSet attrs, int defStyle) {
    ...
    private void init(Context context, AttributeSet attributeSet) {
        mVisible = true;
        mColorNormal = getColor(R.color.fab_explore_colour);
        ...
        if (attr != null) {
            try {
                mColorNormal = attr.getColor(R.styleable.FloatingActionButton_fab_colorNormal,
                        getColor(R.color.fab_explore_colour));
