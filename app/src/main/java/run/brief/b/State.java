...
public final class State {
	...
	public static final int SECTION_EMAIL=150;
	public static final int SECTION_EMAIL_VIEW=151;
	public static final int SECTION_EMAIL_NEW=152;
	public static final int SECTION_EMAIL_FOLDER=153;
    public static final int SECTION_EMAIL_SIGNATURES=154;

	
	public static final int SECTION_CONTACTS=3;
	public static final int SECTION_CONTACTS_ITEM=4;
	public static final int SECTION_NOTES=5;
	public static final int SECTION_NOTES_ITEM=6;
	...
	public static final int SECTION_DIRECT=9;
	public static final int SECTION_BLAZE=10;
	...
	public static final int SECTION_PHONE=20;
	
	public static final int SECTION_SMS=30;
	public static final int SECTION_SMS_SEND=31;
	
	public static final int SECTION_D2D=35;
	public static final int SECTION_D2D_SEND=36;
	
	public static final int SECTION_TWITTER=40;
	public static final int SECTION_LINKEDIN=50;
	public static final int SECTION_FACEBOOK=60;
	public static final int SECTION_CAMERA=70;
	public static final int SECTION_NEW_ACTION=80;
	
	public static final int SECTION_ACCOUNTS=100;
	public static final int SECTION_ACCOUNTS_ADD_EDIT_EMAIL=101;
    public static final int SECTION_ACCOUNTS_ADD_EDIT_EMAIL_SERVERS=102;
	
	public static final int SECTION_LOGS=200;
	...
	public static final int SECTION_SETTINGS_NETWORK =303;

    public static final int SECTION_HELP=400;
    public static final int SECTION_LEGAL=500;

    public final static int SECTION_OAUTH_GOOGLE=601;

    public static final int SECTION_PLUS_MEMBER=999;
    ...
    */
	...
	public synchronized static void setUserStats(BriefUserStats stats) {
		S.stats=stats;
	}
	...
	public static void setBrief(Brief brief) {
		S.brief=brief;
	}
	public static Brief getBrief() {
		return S.brief;
	}
	...
	public static void saveState(Bundle outState) {
		...
		if(!S.sections.isEmpty()) {
			...
			//BLog.e("LOAD", "section: "+S.sections.get(size-1).intValue());
			outState.putInt(SECTION_SAVE_KEY, S.sections.get(size-1).intValue());
		}
		if(State.getCameraLastPhoto()!=null)
			outState.putString(CAMERA_LAST_PHOTO, State.getCameraLastPhoto());
	}
