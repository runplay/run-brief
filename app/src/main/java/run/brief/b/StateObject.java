...
public final class StateObject {
	...
	public static final String STRING_CONTACT_NAME="contact_name";
	public static final String STRING_PHONE_NUMBER="phone_number";
	public static final String STRING_FILE_PATH="file_path";
	public static final String STRING_FROM_EMAIL="from_email";
	public static final String STRING_CONTACTS="contacts";
	public static final String STRING_SMS_REPONDTO="sms_resp";
	public static final String STRING_EMAIL_SUMMARY="emsumm";
	public static final String INT_FORCE_NEW="force_new";
	public static final String INT_USE_SELECTED_INDEX="sel_index";
    public static final String STRING_USE_DATABASE_ID="sel_db_id";
	public static final String INT_USE_SELECTED_BRIEF_INDEX="sel_b_index";
	public static final String LONG_USE_ACCOUNT_ID="sel_account";
